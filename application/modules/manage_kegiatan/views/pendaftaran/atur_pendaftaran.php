    ...
    <div class="col-sm mb-2 mb-sm-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-no-gutter">
          <li class="breadcrumb-item"><a class="breadcrumb-link" href="<?= site_url('manage-kegiatan') ?>">Dashboard</a></li>
...
<form action="<?= site_url('manage_kegiatan/'.($cek_form == true ? 'proses_updatePendaftaran' : 'proses_aturPendaftaran'));?>" method="POST">
      ...
      <div id="dynamic_field">
        ...
        <div class="col-3">
          <div class="sticky-top">
            <button type="submit" class="btn btn-sm btn-primary btn-block"><?= $cek_form == true ? 'Update' : 'Atur';?> formulir</button>
            <?php if($cek_form == true):?>
              <a href="<?= site_url('daftar/'.$this->session->userdata('manage_kegiatan'));?>" target="_blank" class="btn btn-sm btn-info btn-block">Lihat formulir</a>
            <?php endif;?>
            <hr>
            <div class="card">

    ...
    <div class="col-lg-12">
		<div class="card">
			...
			<form id="form-anggota">
				...
				<div class="card-header border-bottom pb-2">
					<h5 class="card-header-title">Anggota TIM <i><?= $dataPendaftaran->NAMA_TIM;?></i> <small class="text-danger">max 4 anggota TIM</small></h5>
					<button type="button" class="btn btn-info btn-xs btn-sm <?= $dataAnggota != false ? (count($dataAnggota) >= 3 ? 'd-none' : '') : '';?>" id="add">Tambah field anggota</button>
				</div>
				<div class="card-body">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#add').click(function(){
					i++;
					if (i >= <?= $dataAnggota != false ? (4-count($dataAnggota)) : 3;?>) {
						$('#add').addClass('d-none'); 
					}else{

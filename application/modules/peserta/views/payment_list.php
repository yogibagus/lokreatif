	...
	<div class="card-body">
		<?php if ($sudahBayar == false) :?>
			<div class="alert alert-info">
				<p class="mb-0">Anda memiliki proses pembayaran yang belum selesai, harap lanjutkan proses pembayaran anda dengan memilih salah satu riwayat pembayaran anda !!</p>
			</div>
		<?php else:?>
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				<?php $no=1; foreach ($payments as $value):?>
				<tr>
					<td><?= $no++;?></td>

        ...
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card" style="text-align: center;">
                <div class="card-body">
                    ...
                    <div class="h6">Jumlah Mahasiswa</div>
                    <div style="position: absolute;right: 10px;bottom: 10px;">
                        <svg height="40pt" width="40pt" enable-background="new 0 0 273.052 273.052" version="1.1" viewBox="0 0 273.05 273.05" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g fill="rgba(245,202,153,0.8)"><circle cx="138.17" cy="73.52" r="73.52"/><path d="m126.38 171.37c6.728 3.236 17.65 3.236 24.378 0l67.047-32.243c6.734-3.236 13.989-0.082 16.208 7.054l20.032 64.35c2.219 7.136 0.234 17.65-4.433 23.48l-1.137 1.425c-3.807 4.759-11.058 8.784-17.661 24.797-2.85 6.913-10.378 12.82-17.846 12.82h-149.93c-7.473 0-14.99-5.901-17.873-12.793-6.679-15.947-14.163-19.776-18.259-24.291l-3.263-3.612c-5.015-5.537-6.995-15.719-4.427-22.735l23.279-63.647c2.567-7.016 10.106-10.079 16.839-6.842l67.042 32.237z"/></g></svg>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card" style="text-align: center;">
                <div class="card-body">
                    ...
                    <div class="h6">Jumlah PTS Berpartisipasi</div>
                </div>
                <div style="position: absolute;right: 10px;bottom: 10px;">

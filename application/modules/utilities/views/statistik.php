    ...
    <div class="row">
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card" style="text-align: center;">
                <div class="card-body">
                    <div class="js-counter h2"><?= number_format(12,0,",",".")?></div>
                    <div class="h6">PT Sudah Diverifikasi</div>
        ...
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card" style="text-align: center;">
                <div class="card-body">
                    <div class="js-counter h2"><?= number_format(34,0,",",".")?></div>
                    <div class="h6">PT Belum Diverifikasi</div>
                    <div style="position: absolute;right: 10px;bottom: 10px;">
        ...
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card" style="text-align: center;">
                <div class="card-body">
                    <div class="js-counter h2"><?= number_format(102,0,",",".")?></div>
                    <div class="h6">Total PT</div>
                </div>
                <div style="position: absolute;right: 10px;bottom: 10px;">
        ...
        <div class="col-md-4 col-sm-12" style="margin-top: 25px;">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <h6 id="kategori_title" style="text-align: center;">TikTok</h6>
                    <div style="margin-top: 25px;" id="chartKategori"></div>
                    <div style="float: right;">
                        <img id="kategori_img" src="<?= base_url('berkas/kompetisi/bidang-lomba/tiktok.png')?>" style="max-width: 50px;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <table id="ok" class="table table-thead-bordered">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Kode</th>
...
<script>
    $(document).ready(function(){
        let kategoriData = [
            {
                ...
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/web-mobile.png')?>",
                data: [22,33,44]
            },
            {
                title: "Video Pendek",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/video.png')?>",
                data: [44,33,22]
            },
            {
                title: "Desain Poster",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/poster.png')?>",
                data: [123,324,12]
            },
            {
                title: "Ide Bisnis",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/ide-bisnis.png')?>",
                data: [452,12,23]
            },
            {
                title: "Fotografi",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/fotografi.png')?>",
                data: [43,33,22]
            },
            {
                title: "Game",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/games.png')?>",
                data: [11,10,9]
            },
            {
                title: "TIKTOK",
                img: "<?= base_url('berkas/kompetisi/bidang-lomba/tiktok.png')?>",
                data: [33,53,67]
            },
            {
                title: "Unjuk Talenta",
        ...
        function randomize() {
            return chartKategori.w.globals.series.map(function() {

...
<div class="container space-top-1 space-bottom-2">
        ...
        <div class="col-md-7 mb-5 mb-md-0">
          <div class="media align-items-center">
            <div class="avatar avatar-circle">
              <img class="avatar-img" src="<?= base_url();?>assets/frontend/img/100x100/img11.jpg" alt="Image Description">
            </div>
            <div class="media-body font-size-1 ml-3">
              <span class="h6"><a href="blog-profile.html">Hanna Wolfe</a></span>
  ...
  <div class="my-4 my-sm-8">
    <img class="img-fluid rounded-lg" src="<?= base_url();?>assets/frontend/img/1920x800/img5.jpg" alt="Image Description">
  </div>
  ...
  <div class="w-lg-60 mx-lg-auto">
        ...
        <li class="mb-5">
          <div class="media align-items-center mb-2">
            <div class="avatar avatar-circle mr-3">
              <img class="avatar-img" src="<?= base_url();?>assets/frontend/img/100x100/img3.jpg" alt="Image Description">
            </div>
    ...
    <form class="js-validate">
      <div class="form-row">
        <div class="col-sm-6 mb-sm-3">
          <div class="js-form-message form-group">
            ...
            <input type="text" class="form-control" name="name" id="inputName" placeholder="form" aria-label="Name" required
        ...
        <div class="col-12 mb-sm-3">
          <div class="js-form-message form-group">
            ...
            <textarea class="form-control" rows="7" id="descriptionTextarea" placeholder="Komentar" required
      ...
      <div class="d-flex justify-content-center">
        <button type="submit" class="btn btn-primary btn-wide transition-3d-hover">Kirim</button>
      </div>
    </form>
    <!-- End Form -->
  </div>

            ...
            <div class="card-body">
              ...
              <div class="d-none d-lg-block text-center mb-5">
                <div class="avatar avatar-xxl avatar-circle avatar-circle-uploader avatar-border-lg cursor shadow-soft mb-3" data-toggle="modal" data-target="#ubah_profil">
                  <img class="avatar-img" src="<?= ($pFoto->PROFIL == null ? base_url().'assets/frontend/img/100x100/img12.jpg' : base_url().'berkas/univ/'.$this->session->userdata('kode_user').'/foto/'.$pFoto->PROFIL);?>" alt="<?= $this->session->userdata('nama') ?>">
              ...
              <div id="ubah_profil" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ubah_profil" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                  <div class="modal-content">
                    <form action="<?= site_url('univ/ubah_foto') ?>" method="post" enctype="multipart/form-data">
                      <div class="modal-body pb-0">
                        ...
                        <div class="form-group mx-auto mb-2">
                          ...
                          <label for="GETP_FOTO" class="upload-card mx-auto">
                            <img id="P_FOTO" class="upload-img w-100 P_FOTO cursor" src="<?= ($pFoto->PROFIL == null ? base_url().'assets/frontend/img/others/Pickanimage.png' : base_url().'berkas/univ/'.$this->session->userdata('kode_user').'/foto/'.$pFoto->PROFIL);?>" alt="Placeholder">
                          </label>
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="<?= site_url('univ/hapus_foto') ?>" class="btn btn-sm btn-danger">Hapus foto</a>
              ...
              <ul class="nav nav-sub nav-sm nav-tabs nav-list-y-2 mb-4">
                ...
                <li class="nav-item">
                  <a class="nav-link <?= ($this->uri->segment(2) == "notifikasi" ? "active" : "") ?>" href="<?= site_url('univ/notifikasi') ?>">
                ...
                <li class="nav-item">
                  <a class="nav-link <?= ($this->uri->segment(2) == "pengaturan" ? "active" : "") ?>" href="<?= site_url('univ/pengaturan') ?>">
              ...
              <ul class="nav nav-sub nav-sm nav-tabs nav-list-y-2 mb-4">
                <li class="nav-item">
                  <a class="nav-link <?= ($this->uri->segment(2) == "data-pendaftaran" ? "active" : "") ?>" href="<?= site_url('univ/data-pendaftaran') ?>">
                    <i class="fas fa-clipboard nav-icon"></i> Data pendaftaran
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?= ($this->uri->segment(2) == "kegiatan" ? "active" : "") ?>" href="<?= site_url('univ/kegiatan') ?>">

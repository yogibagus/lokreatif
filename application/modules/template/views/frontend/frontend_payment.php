            ...
            <div id="logoAndNav" class="container-fluid">
                ...
                <nav class="navbar navbar-expand header-navbar">
                    ...
                    <a class="d-flex d-lg-none navbar-brand header-navbar-brand header-navbar-brand-collapsed" href="<?= base_url() ?>" aria-label="<?= $WEB_JUDUL; ?>">
                        <img src="<?= base_url(); ?>assets/logo-ts.png" class="" alt="Logo">
                    </a>
                    <!-- End Default Logo -->
                    ...
                    <div class="ml-auto">
                        <?php if ($this->session->userdata('role') == 1) { ?>
                            <a class="btn btn-sm btn-link text-body" href="<?= base_url('peserta/riwayat-pembayaran') ?>">
                                <i class="fas fa-angle-left fa-sm mr-1"></i> Riwayat Pembayaran
                            </a>
                        <?php } else if ($this->session->userdata('role') == 3) { ?>
                            <a class="btn btn-sm btn-link text-body" href="<?= base_url('transaksi-pts') ?>">
                                <i class="fas fa-angle-left fa-sm mr-1"></i> Daftar Transaksi
                            </a>
                        <?php } ?>
                    </div>
                    <!-- End Button -->

    ...
    <div class="col-sm mb-2 mb-sm-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-no-gutter">
          ...
          <li class="breadcrumb-item active" aria-current="page">Pengajuan K-Panel</li>
        </ol>
      </nav>

      <h1 class="page-header-title">Pengajuan K-Panel</h1>
    </div>
...
<tbody>
  <?php if ($countPengajuan > 0): ?>
    ...
    <tr>
      ...
      <td>
        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#terimaPenyelenggara<?= $key->KODE_PENYELENGGARA;?>">
          <i class="tio-checkmark-square-outlined"></i> Terima
        </a>
        <a class="btn btn-sm btn-danger" data-toggle="modal" data-target="#tolakPenyelenggara<?= $key->KODE_PENYELENGGARA;?>">
          <i class="tio-clear-square-outlined"></i> Tolak
        </a>
      </td>
    </tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= site_url('admin/terimaPenyelenggara') ?>" method="POST">
            ...
            <input type="hidden" name="RECEIVER" value="<?= $CI->M_admin->get_pengajuKode($key->KODE_PENYELENGGARA); ?>">
            ...
            <div class="modal-footer px-0">
              ...
              <button type="submit" class="btn btn-sm btn-success mr-0">Terima</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= site_url('admin/tolakPenyelenggara') ?>" method="POST">
            ...
            <div class="modal-footer px-0">
              <button type="button" class="btn btn-sm btn-white" data-dismiss="modal">Batal</button>
              <button type="submit" class="btn btn-sm btn-danger mr-0">Tolak</button>
            </div>
          </form>
        </div>
      </div>

                        ...
                        <?php else : ?>
                            ...
                            foreach ($get_pendaftaran as $data) : ?>
                                <tr>
                                    ...
                                    <?php foreach ($get_form as $key) : ?>
                                        <td>
                                            <?php if ($CI->M_kordinator->get_formData($data->KODE_PENDAFTARAN, $key->ID_FORM) == false) : ?>
                                                <button type="button" class="btn btn-xs btn-secondary">belum melengkapi</button>
                                            <?php else : ?>
                                                <a href="<?= base_url(); ?>berkas/pendaftaran/kompetisi/lokreatif/<?= $data->KODE_USER; ?>/<?= $CI->M_kordinator->get_formData($data->KODE_PENDAFTARAN, $key->ID_FORM); ?>" class="btn btn-xs btn-warning" target="_blank">cek berkas</a>
                                            <?php endif; ?>
                                        </td>
                                    <?php endforeach; ?>
                                </tr>
